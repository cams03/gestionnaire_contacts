...
while (saisieMenu !== 0) {
    ...
    console.log("1 : Lister les contacts \n2 : Ajouter un contact \n3 : Supprimer le dernier contact \n0 : Quitter");

    saisieMenu = Number(prompt("Choisissez une option", "<Entrez une option>"));

    if ((saisieMenu !== 0) && (saisieMenu !== 1) && (saisieMenu !== 2) && (saisieMenu !== 3)) {
        console.log("Avez-vous fait une erreur? Les choix possibles sont 1, 2, 3 ou 0. Entrez de nouveau une option");
    }
    ...
    if (saisieMenu === 1) {
        ...
        table.pop();
        console.log("Le dernier contact a été supprimé");
